   ...
   <div  className="about-container" style={bgPic}> 
    <div id="about" className="image-area">
        ...
        <div className="text-container">
            ...
            <p className="item-3">Founder and owner with 23 years of experience as pediatric speech pathologist and a feeding  specialist. Worked in various settings, including early intervention, private practice, hospitals, daycare centers, preschools and elementary schools.
